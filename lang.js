...
I am open to feedback and highly adaptable.`,
      ...
      skills: {
        ...
        list: [
          ...
          "JavaScript", "HTML5", "Django", "PyQt / PySide", "PostgreSQL",
          "Linux Command Line", "Constructive Feedback Acceptance", "Emotional Control (Anger Management)",
...
پذیرای بازخورد هستم و به‌خوبی با تغییرات سازگار می‌شوم.`,
      ...
      skills: {
        ...
        list: [
          ...
          "خط فرمان لینوکس", "پذیرش بازخورد سازنده", "کنترل خشم",
          "اخلاق کاری", "سازگاری", "حل مسئله", "کار تیمی",
        ],
      },
      projects: {
        title: "پروژه‌ها",
